...
class Scene:
    ...
    def __init__(self, args : ModelParams, gaussians : GaussianModel, mlp : MLPModel, load_iteration=None, shuffle=True, resolution_scales=[1.0]):
        ...
        if os.path.exists(os.path.join(args.source_path, "sparse")):
            ...
            scene_info = sceneLoadTypeCallbacks["Blender"](args.source_path, args.white_background, args.eval, args.object_path)
        else:
    ...
    def save(self, iteration, save_palette_and_mlp=True, save_obj=False):
        point_cloud_path = os.path.join(self.model_path, "point_cloud/iteration_{}".format(iteration))
        self.gaussians.save_ply(os.path.join(point_cloud_path, "point_cloud.ply"), save_obj)
